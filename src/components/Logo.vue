<template>
  <div id="bran-logo" class="px-1 py-1">
    <svg class="fill-current" width="29" height="29" xmlns="http://www.w3.org/2000/svg" fill-rule="evenodd" clip-rule="evenodd">
      <path
  ...
  <p id="logo-text" class="block text-2xl">
    <a href="https://www.youtube.com/watch?v=HJ7zbzJZsjs" target="_blank">Keep Talking</a>
  </p>
</template>
